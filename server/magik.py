			...
			if url:
				...
				if any(s in middle for s in ['.jpg', '.JPG', '.gif', '.GIF', '.bmp', '.BMP', '.png', '.PNG', '.jpeg', '.JPEG', 'gstatic.com/images']) and not imgurgifvmatch:
					...
					if has_stuff:
						...
						middle = '<iframe id=sc_' + str(sc_id) + ' style="padding-top:10px" width="600" height="300" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https://api.soundcloud.com/tracks/' + str(track.id) + '&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>'
						has_stuff = True
					...
					if has_stuff:
						...
						sc_id = random_string(20)
						middle = '<iframe id=sc_' + str(sc_id) + ' style="padding-top:10px" width="600" height="350" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https://api.soundcloud.com/playlists/' + str(playlist.id) + '&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>'
						has_stuff = True
